---
{
  ...
  "description": "Use a bigger model when the expected cost of failure exceeds the incremental model cost, or when retrieval, safety, verification, or domain risk ",
  ...
  "definition": "When to Use a Bigger Model is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.",
...
## Definition
When to Use a Bigger Model is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.
