---
{
  ...
  "description": "Knowledge-base agents should retrieve relevant source material before answering. If evidence is missing or weak, they should show the gap, retrie",
  ...
  "definition": "Grounding Beats Guessing is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.",
...
## Definition
Grounding Beats Guessing is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.
