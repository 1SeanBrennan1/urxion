---
{
  ...
  "description": "Prompts can guide model behavior, but they cannot reliably enforce authorization, privacy, tool policy, or high-risk workflow controls. Safety mu",
  ...
  "definition": "Prompts Do Not Enforce Safety is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.",
...
## Definition
Prompts Do Not Enforce Safety is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.
