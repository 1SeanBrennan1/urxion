---
{
  ...
  "description": "Every durable memory fact should point back to its source. Without provenance, agents can preserve extraction errors, user mistakes, or stale ass",
  ...
  "definition": "Source-Linked Memory Prevents False Memories is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.",
...
## Definition
Source-Linked Memory Prevents False Memories is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.
