---
{
  ...
  "description": "Agent evaluation should inspect the full path: retrieved evidence, tool choices, tool arguments, state changes, intermediate artifacts, final out",
  ...
  "definition": "Test the Trajectory, Not Just the Answer is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.",
...
## Definition
Test the Trajectory, Not Just the Answer is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.
