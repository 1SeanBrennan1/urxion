---
{
  ...
  "description": "Production agents need structured traces for inputs, routing, retrieval, tool calls, memory reads and writes, costs, errors, approvals, and final",
  ...
  "definition": "Agent Observability Starts With Traces is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.",
...
## Definition
Agent Observability Starts With Traces is part of a practical engineering framework for reliable, evidence-first AI agents. The focus is operational control, not hype.
